...
const Portfolio: React.FC = () => {
  const projects = [
    ...
    {
      title: 'Ekdukan Shop',
      description: 'E-commerce platform for online shopping with product catalog, shopping cart, secure checkout, and order management system.',
      tags: ['MERN Stack', 'Redux', 'Stripe', 'E-commerce'],
      liveUrl: 'https://ekdukan.shop',
      githubUrl: 'https://github.com/imnomee/ekdukan.shop',
    },
    {
      title: 'DairyMan',
