    ...
    return (
        <Section
            ...
            <div className="relative max-w-4xl mx-auto">
                ...
                <div className="absolute top-1/2 left-6 transform -translate-y-1/2 -translate-x-full md:-translate-x-12">
                    <button
                        onClick={prev}
                ...
                <div className="absolute top-1/2 right-6 transform -translate-y-1/2 translate-x-full md:translate-x-12">
                    <button
                        onClick={next}
                        className="p-2 rounded-full bg-dark-700 text-white hover:bg-primary-700 transition-colors"
