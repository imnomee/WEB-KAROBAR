        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl mb-8">
              We create stunning websites and digital solutions that help your business grow.
            </p>
            ...
            {[
              {
                name: 'Sarah Johnson',
                role: 'CEO, TechStart',
                content: 'WebKarobar transformed our online presence. Their team delivered beyond our expectations.',
                rating: 5,
              },
              {
                name: 'Michael Chen',
                role: 'Founder, GrowthLabs',
                content: "Professional, responsive, and incredibly talented. They're our go-to agency for all things digital.",
                rating: 5,
              },
              {
                name: 'Emma Williams',
                role: 'Marketing Director, InnovateCo',
                content: 'Outstanding service and results. Our website traffic has doubled since working with them.',
                rating: 5,
              },
