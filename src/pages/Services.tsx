...
export default function Services() {
  return (
    <>
      <Helmet>
        <title>Services & Pricing - WebKarobar | Web Development Agency</title>
        <meta name="description" content="Explore our comprehensive web development services and transparent pricing packages. From basic websites to full-scale digital solutions." />
        <meta name="keywords" content="web development services, website pricing, digital solutions, WebKarobar services" />
      ...
      <div className="py-20">
        ...
        <section className="container mx-auto px-4 mb-20">
          <div className="text-center max-w-3xl mx-auto">
            <h1 className="text-4xl font-bold mb-6">Our Services & Pricing</h1>
        ...
        <section className="container mx-auto px-4">
          <div className="bg-gray-50 rounded-lg p-12 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Let's discuss your specific requirements and create a tailored package for you.
            </p>
